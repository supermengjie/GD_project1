...
The German Empire has won.";
	...
	override public function create():Void
	{
		...
		fg.loadGraphic("assets/images/Background1_Houses_Destruction4.png", false, 512, 157);
		fg2.loadGraphic("assets/images/Background1_Houses_Destruction4.png", false, 512, 157);
		...
		spawn.start(FlxG.random.float(2.0, 3.0), birdSpawner, 0);
